...
export default function Footer() {
  ...
  return (
    <div className={styles.footerContainer}>
        ...
        <p onClick={toContact} className={styles.ptLink}>Contact us</p><br />
        <p className={styles.disclaimer}>Reddder does not store any files on our server, we only linked to the media which is hosted on Reddit.</p>
      </div>
  )
}
